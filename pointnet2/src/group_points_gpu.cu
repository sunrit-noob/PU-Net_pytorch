...
void group_points_grad_kernel_launcher_fast(int b, int c, int n, int npoints, int nsample, 
    ...
    group_points_grad_kernel_fast<<<blocks, threads, 0>>>(b, c, n, npoints, nsample, grad_out, idx, grad_points);
...
void group_points_kernel_launcher_fast(int b, int c, int n, int npoints, int nsample, 
    ...
    group_points_kernel_fast<<<blocks, threads, 0>>>(b, c, n, npoints, nsample, points, idx, out);
